export function validateRegisterForm(form) {
  ...
  if (!formData.get('username').trim()) errors.username = "Le nom d'utilisateur est requis";
  ...
  if (!strongPasswordRegex.test(password)) {
    errors.password = 'Mot de passe invalide : 12 caractères minimun, 1 majuscule, 1 chiffre, 1 caractère spécial';
  }
